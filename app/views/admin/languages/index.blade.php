...
<tbody>
	...
	<tr>
		...
		<td class="actions">
			...
			@if ($delete)
			{{ link_to_route("$prefix.destroy", _('Delete'), array($resource->id), array('class' => 'small alert radius button toggle-delete-modal', 'title' => e(sprintf(_('Delete %s'), $resource->english_name)))) }}
			@endif
		</td>
		@endif
	</tr>
