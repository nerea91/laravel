...
class Account extends Model
{
	...
	public function __construct(array $attributes = [])
	{
		...
		$this->setRules([
			...
			'nickname'     => [_('Nickname'), 'nullable|max:128'],
			'email'        => [_('E-mail'), 'nullable|email|max:255'],
			'name'         => [_('Name'), 'nullable|max:128'],
			'first_name'   => [_('First name'), 'nullable|max:64'],
			'last_name'    => [_('Last name'), 'nullable|max:64'],
			'image'        => [_('Image'), 'nullable|max:255'],
			'locale'       => [_('Locale'), 'nullable|max:5'],
			'location'     => [_('Location'), 'nullable|max:128'],
