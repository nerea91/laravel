...
class BaseResourceController extends BaseController {
	...
	public function index()
	{
		...
		$this->layout->content = View::make($this->extractResourcePrefix($this->prefix, 'index'), $data);
	}
	...
	public function create()
	{
		...
		$this->layout->content = View::make($this->extractResourcePrefix($this->prefix, 'create'), $data);
	}
	...
	public function show($id)
	{
		...
		$this->layout->content = View::make($this->extractResourcePrefix($this->prefix, 'show'), $data);
	}
	...
	public function edit($id)
	{
		...
		$this->layout->content = View::make($this->extractResourcePrefix($this->prefix, 'edit'), $data);
	}
	...
	/**
	 * Extracts the prefix from a resource controller route name.
	 *
